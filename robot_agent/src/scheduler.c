...
my_victim_t get_victim(char const* id) {
  ...
  if (!strcmp(id, "020058F5BD"))      { v.x = 340; v.y = 340; nr = 1;    }
  else if (!strcmp(id, "020053A537")) { v.x = 975; v.y = 1115; nr = 2;   }
  else if (!strcmp(id, "020053E0BA")) { v.x = 1845; v.y = 925; nr = 3;   }
  else if (!strcmp(id, "01004B835E")) { v.x = 2670; v.y = 335; nr = 4;   }
  else if (!strcmp(id, "020053C80E")) { v.x = 3395; v.y = 870; nr = 5;   }
  else if (!strcmp(id, "020058100D")) { v.x = 4645; v.y = 910; nr = 6;   }
  else if (!strcmp(id, "0200580B96")) { v.x = 4800; v.y = 250; nr = 7;   }
  else if (!strcmp(id, "02005345B6")) { v.x = 5395; v.y = 1060; nr = 8;  }
  else if (!strcmp(id, "020058F121")) { v.x = 5830; v.y = 1895; nr = 9;  }
  else if (!strcmp(id, "0200581B9E")) { v.x = 5110; v.y = 2390; nr = 10; }
  else if (!strcmp(id, "020058066F")) { v.x = 5770; v.y = 3790; nr = 11; }
  else if (!strcmp(id, "020058212D")) { v.x = 4500; v.y = 3190; nr = 12; }
  else if (!strcmp(id, "020058022D")) { v.x = 3415; v.y = 3200; nr = 13; }
  else if (!strcmp(id, "0200581542")) { v.x = 4150; v.y = 1810; nr = 14; }
  else if (!strcmp(id, "0200534E5C")) { v.x = 3720; v.y = 3710; nr = 15; }
  else if (!strcmp(id, "020053AB2C")) { v.x = 2580; v.y = 3770; nr = 16; }
  else if (!strcmp(id, "01004A11E8")) { v.x = 2970; v.y = 2805; nr = 17; }
  else if (!strcmp(id, "020053E282")) { v.x = 3030; v.y = 2070; nr = 18; }
  else if (!strcmp(id, "0200553505")) { v.x = 3120; v.y = 1965; nr = 19; }
  else if (!strcmp(id, "01004751A2")) { v.x = 2880; v.y = 1840; nr = 20; }
  else if (!strcmp(id, "02005097C0")) { v.x = 1890; v.y = 2580; nr = 21; }
  else if (!strcmp(id, "020053BF78")) { v.x = 985; v.y = 3020; nr = 22;  }
  else if (!strcmp(id, "020056D0EF")) { v.x = 730; v.y = 3175; nr = 23;  }
  else if (!strcmp(id, "01004BDF7B")) { v.x = 320; v.y = 1800; nr = 24;  }
